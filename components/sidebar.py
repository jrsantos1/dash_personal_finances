...
layout = dbc.Col([
    ...
    dbc.Button(id='botao_avatar',
               children=[html.Img(src='/assets/img_hom.png', id='avatar_change', alt='Avatar', className='perfil_avatar')
                         ], style = {'background-color' : 'transparent', 'border-color' : 'transparent', 'display': 'flex'}),
    # Seção Novo ----------------
    dbc.Row([
        dbc.Col([
    ...
    dbc.Modal([
        ...
        dbc.ModalBody([
            ...
            dbc.Row([
                        ...
                        dbc.Row([
                            ...
                            dbc.Col([
                                ...
                                dbc.Checklist(
                                    ...
                                    input_checked_style={'backgroundColor': 'blue', 'borderCalor': 'orange'},
                                ),
                                dbc.Button('Remover', color='warning', id='remove-category-receita', style={'margin': '20px'})
                            ], width=6)
                            ])
                ...
                dbc.ModalFooter([
                    dbc.Button("Adicionar Receita", id="Salvar Receita", color="sucess"),
                    dbc.Popover(dbc.PopoverBody("Receita Salva"), target="salvar_receita", placement="left", trigger="click")
                ])
            ], style={'margin-top': '20px'})
        ])
    ], id = 'modal_novo_receita', style={'background-color': 'rbga(17,140,79,0,05)'},
    size='lg',
    is_open=False,
    centered=True,
    backdrop=True),
...
], style={"border": "2px blue solid", "padding-left": "5px", "left": "0px"}, id='sidebar_completa')
